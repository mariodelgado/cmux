...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .automation, id: "ai-local-hub", title: "Local AI", synonyms: "ai.enabled ai.endpoint ai.appIntents ai.services ai.menuBar local foundation models mlx hub openai compatible qwen summaries triage classify shortcuts siri spotlight services explain rewrite menu bar flagged panes"),
            ...
            .init(section: .terminal, id: "new-terminal-launcher", title: "New Terminal Launcher", synonyms: "newTerminalLauncher.enabled ssh hosts local shell new terminal launcher cards"),
            .init(section: .terminal, id: "new-terminal-launcher-tailscale", title: "Tailscale Devices in Launcher", synonyms: "newTerminalLauncher.tailscale tailscale devices tailnet magicdns ssh hosts new terminal launcher cards"),
            ...
            .init(section: .sidebarAppearance, id: "right-panel-translucent", title: "Translucent Right Panel", synonyms: "rightPanel.translucent right sidebar panel opaque solid translucent material glass inspector dock vault tinyfish contrast"),
            ...
            .init(section: .browser, id: "tinyfish", title: String(localized: "settings.browser.tinyfish.enabled", defaultValue: "TinyFish Remote Browser"), synonyms: "tinyfish.enabled tinyfish.apiKey tinyfish.timeoutSeconds cloud remote browser screenshots cdp api key"),
