...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .automation, id: "ai-local-hub", title: "Local AI", synonyms: "ai.enabled ai.endpoint ai.appIntents ai.services local foundation models mlx hub openai compatible qwen summaries triage classify shortcuts siri spotlight services explain rewrite"),
