enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "terminal:new-terminal-launcher": localized("settings.search.alias.setting.terminal.new-terminal-launcher", defaultValue: "newTerminalLauncher.enabled ssh hosts local shell new terminal launcher cards"),
        "terminal:new-terminal-launcher-tailscale": localized("settings.search.alias.setting.terminal.new-terminal-launcher-tailscale", defaultValue: "newTerminalLauncher.tailscale tailscale devices tailnet magicdns ssh hosts new terminal launcher cards"),
        ...
        "sidebarAppearance:right-panel-translucent": localized("settings.search.alias.setting.sidebarAppearance.right-panel-translucent", defaultValue: "rightPanel.translucent right sidebar panel opaque solid translucent material glass inspector dock vault tinyfish contrast"),
        ...
        "automation:ai-local-hub": localized("settings.search.alias.setting.automation.ai-local-hub", defaultValue: "ai.enabled ai.endpoint ai.appIntents ai.services ai.menuBar local foundation models mlx hub openai compatible qwen summaries triage classify shortcuts siri spotlight services explain rewrite menu bar flagged panes"),
        ...
        "browser:tinyfish": localized("settings.search.alias.setting.browser.tinyfish", defaultValue: "tinyfish.enabled tinyfish.apiKey tinyfish.timeoutSeconds remote cloud browser screenshot cdp api key"),
