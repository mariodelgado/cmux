enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "automation:ai-local-hub": localized("settings.search.alias.setting.automation.ai-local-hub", defaultValue: "ai.enabled ai.endpoint ai.appIntents ai.services local foundation models mlx hub openai compatible qwen summaries triage classify shortcuts siri spotlight services explain rewrite"),
