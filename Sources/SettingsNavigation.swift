...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.automation, "ai-local-hub", String(localized: "settings.automation.ai", defaultValue: "Local AI"), "ai.enabled ai.endpoint ai.appIntents ai.services local foundation models mlx hub openai compatible shortcuts siri spotlight services summaries triage rewrite explain"),
