...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "new-terminal-launcher", String(localized: "settings.newTerminalLauncher.enabled", defaultValue: "New Terminal Launcher"), "newTerminalLauncher.enabled ssh hosts local shell new terminal launcher cards"),
        setting(.terminal, "new-terminal-launcher-tailscale", String(localized: "settings.newTerminalLauncher.tailscale", defaultValue: "Tailscale Devices in Launcher"), "newTerminalLauncher.tailscale tailscale devices tailnet magicdns ssh hosts new terminal launcher cards"),
        ...
        setting(.sidebarAppearance, "right-panel-translucent", String(localized: "settings.sidebarAppearance.rightPanelTranslucent", defaultValue: "Translucent Right Panel"), "rightPanel.translucent right sidebar panel opaque solid translucent material glass inspector dock vault tinyfish contrast"),
        ...
        setting(.automation, "ai-local-hub", String(localized: "settings.automation.ai", defaultValue: "Local AI"), "ai.enabled ai.endpoint ai.appIntents ai.services ai.menuBar local foundation models mlx hub openai compatible shortcuts siri spotlight services menu bar summaries triage rewrite explain flagged panes"),
        ...
        setting(.browser, "tinyfish", String(localized: "settings.browser.tinyfish.enabled", defaultValue: "TinyFish Remote Browser"), "tinyfish cloud remote browser screenshot cdp api key"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "newTerminalLauncher.enabled": settingID(for: .terminal, idSuffix: "new-terminal-launcher"),
        "newTerminalLauncher.tailscale": settingID(for: .terminal, idSuffix: "new-terminal-launcher-tailscale"),
        ...
        "rightPanel.translucent": settingID(for: .sidebarAppearance, idSuffix: "right-panel-translucent"),
        ...
        "ai.enabled": settingID(for: .automation, idSuffix: "ai-local-hub"),
        "ai.endpoint": settingID(for: .automation, idSuffix: "ai-local-hub"),
        "ai.appIntents": settingID(for: .automation, idSuffix: "ai-local-hub"),
        "ai.services": settingID(for: .automation, idSuffix: "ai-local-hub"),
        "ai.menuBar": settingID(for: .automation, idSuffix: "ai-local-hub"),
        ...
        "tinyfish.enabled": settingID(for: .browser, idSuffix: "tinyfish"),
        "tinyfish.apiKey": settingID(for: .browser, idSuffix: "tinyfish"),
        "tinyfish.timeoutSeconds": settingID(for: .browser, idSuffix: "tinyfish"),
