...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.automation, "ai-local-hub", String(localized: "settings.automation.ai", defaultValue: "Local AI"), "ai.enabled ai.endpoint local mlx hub openai compatible summaries triage"),
